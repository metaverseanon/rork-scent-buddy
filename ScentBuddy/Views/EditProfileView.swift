...
struct EditProfileView: View {
    ...
    @State private var selectedEmoji: String = "\u{1F9F4}"

    private let emojiOptions = ["\u{1F9F4}", "\u{1F490}", "\u{1F338}", "\u{1F33F}", "\u{1F525}", "\u{2728}", "\u{1F5A4}", "\u{1F48E}", "\u{1F319}", "\u{1F34A}", "\u{1FAE7}", "\u{1FAB7}"]
